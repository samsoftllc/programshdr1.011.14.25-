...
class Game:
    def __init__(self):
        pygame.init()
        pygame.display.set_caption("Original Platformer — 32 Levels")
        ...
        self.state = "play"   # play | win | gameover
    ...
    def run(self):
        while True:
            ...
            cam_x = clamp(int(self.player.rect.centerx - BASE_W // 2), 0, self.level.w * TILE - BASE_W)
            ...
            if self.state == "play":
                ...
                hud_surf = self.font.render(hud, True, COL_TEXT)
                self.base_surf.blit(hud_surf, (4, 4))
            elif self.state == "win":
                msg1 = "YOU WIN!"
                msg2 = "Press Enter to play again."
                s1 = self.font.render(msg1, True, COL_TEXT)
                s2 = self.font.render(msg2, True, COL_TEXT)
